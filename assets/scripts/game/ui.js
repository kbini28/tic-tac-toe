...
const signUpSuccess = function (response) {
  $('form').trigger('reset')
  $('#message').text('Sign up successful! Welcome ' + response.user.email + '!').show().removeClass().addClass('success')
...
const signInSuccess = function (response) {
  $('form').trigger('reset')
  $('#message').text('Welcome back ' + response.user.email + '!').show().removeClass().addClass('success')
  $('#logged-out-view').hide()
  $('.hidden').removeClass('hidden')
...
const changePassSuccess = function (response) {
  $('form').trigger('reset')
  $('#message').text('Password updated!').show().removeClass().addClass('success')
...
const signOutSuccess = function () {
  $('form').trigger('reset')
  $('#message').text('Goodbye!').show().removeClass().addClass('success')
